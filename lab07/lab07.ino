...
long get_sonar_val() {
	...
	long current_val = pulseIn(echoPin, HIGH, 2000);
...
void loop() {
	...
	long pulseLength = get_sonar_val();
	long centimeters = pulseLength / 58;
	...
	if (centimeters <= 15 and centimeters != -1) {
